 ...
 */
public class EftPacs00800102Req {
    ...
    public EftIncommingBulkPaymentsReq cdtTrfTxInf;
    ...
    public EftIncommingBulkPaymentsReq getCdtTrfTxInf() {
        return cdtTrfTxInf;
    }

    public void setCdtTrfTxInf(EftIncommingBulkPaymentsReq cdtTrfTxInf) {
    ...
    public String toString() {
        return "EftPacs00800102Req{" + "msgId=" + msgId + ", creDtTm=" + creDtTm + ", nbOfTxs=" + nbOfTxs + ", ttlIntrBkSttlmAmt=" + ttlIntrBkSttlmAmt + ", ttlIntrBkSttlmCcy=" + ttlIntrBkSttlmCcy + ", intrBkSttlmDt=" + intrBkSttlmDt + ", sttlmMtd=" + sttlmMtd + ", instdAgt=" + instdAgt + ", cdtTrfTxInf=" + cdtTrfTxInf + '}';
    }
